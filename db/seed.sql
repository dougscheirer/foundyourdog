...
insert into incidents (map_latitude, map_longitude, dog_id, incident_date, state, resolution) values
				      (37.9688918, -122.1025406, 1, '09/26/2016', 'lost', 0); 
insert into incidents (map_latitude, map_longitude, dog_id, incident_date, state, resolution) values
				      (37.9698918, -122.1025506, 1, '09/27/2016', 'found', 0); 
insert into incidents (map_latitude, map_longitude, dog_id, incident_date, state, resolution) values
				      (37.9708918, -122.1025606, 1, '09/28/2016', 'lost', 0); 
insert into incidents (map_latitude, map_longitude, dog_id, incident_date, state, resolution) values
				      (37.9718918, -122.1025706, 1, '09/29/2016', 'found', 0); 
insert into incidents (map_latitude, map_longitude, dog_id, incident_date, state, resolution) values
				      (37.9728918, -122.1025806, 1, '09/30/2016', 'lost', 0); 
