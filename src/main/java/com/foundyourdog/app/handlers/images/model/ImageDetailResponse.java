...
public class ImageDetailResponse {
	...
	private ArrayList<String> cloudTags; // (outbound) tags in the signature/upload
	private boolean useCredentials;	// (outbound) whether or not to use credentials when uploading
